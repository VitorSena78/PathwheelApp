...
public class LoginActivity extends AppCompatActivity {
        ...
        mRegisterButton.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View view) {
                new Handler().post(new Runnable() {
                    @Override
                    public void run() {
                        startActivity(new Intent(getApplicationContext(), RegisterActivity.class));//inicia a RegisterActivity
        ...
        buttonAnonymous.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                new Handler().post(new Runnable() {
                    @Override
                    public void run() {
                        startActivity(new Intent(getApplicationContext(), MainActivity.class));//inicia a MainActivit
                        finish();
                    }
                });
    ...
    private void attemptLogin() {
        ...
        if (cancel) {
            ...
            //Log.i("loginActivit: ","login cancel");
        } else {
            // Show a progress spinner, and kick off a background task to
            // perform the user login attempt.
            showProgress(true);

            //Log.i("loginActivit: ","login not cancel");
