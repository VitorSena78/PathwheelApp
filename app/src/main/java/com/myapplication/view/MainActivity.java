...
import com.myapplication.fragment.CollaborateFragment;
import com.myapplication.fragment.OsmAddSpotFragment;
import com.myapplication.fragment.OsmManualRouteFragment;
import com.myapplication.fragment.OsmOverviewFragment;
import com.myapplication.fragment.OsmShowNewSpotFragment;
import com.myapplication.fragment.RouteByGoogleFragment;
import com.myapplication.fragment.SelectRouteTypeFragment;
...
public class MainActivity extends AppCompatActivity
    ...
    //fazer pesquisa sobre a biblioteca osmdroid (https://github.com/osmdroid/osmdroid/blob/4740d991a4fcf823981d1c4efa3276058817fcb7/OpenStreetMapViewer/src/main/java/org/osmdroid/samplefragments/data/HeatMap.java)
    @Override
    ...
    public void onRequestPermissionsResult(int requestCode, String permissions[], int[] grantResults) {
        try {
            switch (requestCode) {
                ...
                /*case 1000: {//caso para permisão de escrita no arquivo
                    if (grantResults[0]==PackageManager.PERMISSION_GRANTED) {
                        Log.i("permisoes", "onRequestPermissionsResult: Permissão Concedida!");
                        Toast.makeText(this, "Permissão Concedida!", Toast.LENGTH_SHORT).show();
                    } else {
                        Log.i("permisoes", "onRequestPermissionsResult: Permissão Não Concedida!");
