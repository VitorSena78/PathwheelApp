...
import com.myapplication.api.space.PavementSegment;
    ...
    public View onCreateView(LayoutInflater inflater, final ViewGroup container,
        ...
        endpoint.routeMap(request, new RouteMapListener() {
            ...
            public void onRouteMapPathwheel(RouteMapResponse response) {
                ...
                Log.d("routemap req", "Description: "+response.getDescription());
                Log.d("routemap req", "Code: "+response.getCode());
