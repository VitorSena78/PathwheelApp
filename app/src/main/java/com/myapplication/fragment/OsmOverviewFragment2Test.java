...
public class OsmOverviewFragment2Test extends Fragment {
    ...
    public OsmOverviewFragment2Test() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        map = rootView.findViewById(R.id.mapOsm);
        ...
        marker.setPosition(new org.osmdroid.util.GeoPoint(-22.9059, -43.2095));
