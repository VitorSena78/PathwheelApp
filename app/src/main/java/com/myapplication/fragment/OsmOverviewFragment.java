...
import com.myapplication.api.endpoint.OverviewPavementTestListener;
...
import com.myapplication.api.response.OverviewResponse;
...
public class OsmOverviewFragment extends Fragment {
    ...
    private final String hexAlpha = "#55";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        //View v = inflater.inflate(R.layout.fragment_osm_overview, null);
        //map2 = v.findViewById(R.id.map);


        //IMapController mapC = map2.getController();
        //mapC.setZoom(15d);
        //LatLng latLng2 = PathwheelPreferences.getLastKnownLocation(rootView.getContext());
        //GeoPoint startP = new GeoPoint(latLng2.latitude,latLng2.longitude);
        //mapC.setCenter(startP);

        //handle permissions first, before map is created. not depicted here
        //load/initialize the osmdroid configuration, this can be done
        Context ctx = rootView.getContext();
        Configuration.getInstance().load(ctx, PreferenceManager.getDefaultSharedPreferences(ctx));
        Log.i("TAG", "onCreateView: getInstance()");
        ...
        endpoint.overview(northeast.latitude+","+northeast.longitude,
                ...
                new OverviewPavementTestListener() {
                    ...
                    public void onOverviewPavementTest(final OverviewResponse response) {
                        ...
                        Log.i("overview", "codigo: "+response.getCode()+", descrição: "+response.getDescription());
                        if (response.getCode() == 200) {
                            ...
                            alertDialog.setTitle("Ooops!"+"4");
                            Log.i("Erro de conexao", "Oooooooooooooooooooooooooooooooooooops!");
                            ...
                            alertDialog.show();
                            Log.d("Erro de conexao", response.getDescription());
                            Log.i("Erro de conexao", "Oooooooooooooooooooooooooooooooooooops!");
                            Log.i("Erro de conexao", "response.getDescription()");
                        }
